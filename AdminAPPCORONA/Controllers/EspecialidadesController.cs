...
namespace AdminAPPCORONA.Controllers
{
    public class EspecialidadesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="IDEspecialidad,Nombre")] Especialidade especialidade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="IDEspecialidad,Nombre")] Especialidade especialidade)
        {
            if (ModelState.IsValid)
            {
